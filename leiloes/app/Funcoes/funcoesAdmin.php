...
<option value="0" '.$desocupado[2].'>Não</option>
 ...
 <div class="clear"></div>  </li> 
<li class="wr4 linhas_inputs text "> <div class="finput finput_incremento"> <label class="lnome" for="suites"> <p> Suites: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="number" name="suites" id="suites" value="'.$suite.'" class="design"> </div></div> <div class="clear"></div>  </li>
