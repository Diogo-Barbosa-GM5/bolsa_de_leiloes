...
function replace_lote($modulos,$modulos_abas,$linhas,$conteudo){
    ...
    if($modulos->id == 60):
        ...
        if($linhas->id > 0):
            ...
            $nome = $lotes->nome;
            $nome_meta = $lotes->nome_meta;
            $data_ini = str_replace(' ','T',$lotes->data_ini);
            $data_fim =  str_replace(' ','T',$lotes->data_fim);
            $lance_ini = number_format($lotes->lance_ini,2,'.','') ;
            $lance_min = number_format($lotes->lance_min,2,'.','');
            $categoria = $lotes->categorias;
            $leiloess = $lotes->leiloes;
            $lance_min1 = $lotes->lance_min1;
            $comissao = $lotes->comissao;
            $incremento = $lotes->incremento;
            $acrescimo = $lotes->acrescimo;
            $cep = $lotes->cep;
            $suite = $lotes->suites;
            $bairro = $lotes->bairro;
            $endereco = $lotes->endereco;
            $estados = $lotes->estados;
            $cidades = $lotes->cidades;
            $area_privativa = $lotes->area_privativa;
            $quartos = $lotes->quartos;
            $google_maps = $lotes->google_maps;
            $obs = $lotes->obs;
            $txt_meta = $lotes->txt_meta;
            $txt_extra_01 = $lotes->txt_extra_01;
            $txt_extra_02 = $lotes->txt_extra_02;
            $txt_extra_03 = $lotes->txt_extra_03;



            if($lotes->desocupado == 1):
                $desocupado[1] = 'selected';
            ...
            if($lotes->desocupado == 0):
                $desocupado[2] = 'selected';
            ...
            if($lotes->fase_da_obra == 1):
                    $faseobra[1] = 'selected';
            else:
                    $faseobra[1] = '';
            endif;

            if($lotes->fase_da_obra == 2):
                 $faseobra[2] = 'selected';
            else:
                 $faseobra[2] = '';
            endif;

            if($lotes->fase_da_obra == 3):
                 $faseobra[3] = 'selected';
            else:
                 $faseobra[3] = '';
            endif;
            ...
            if($lotes->bicicletario):
                 $bicicletario = 'checked';
            else:
                $bicicletario = '';
            endif;
            ...
            if($lotes->brinquedoteca):
                 $brinquedoteca = 'checked';
            else:
                $brinquedoteca = '';
            endif;
            ...
            if($lotes->campo_de_futebol):
                 $campo_de_futebol = 'checked';
            else:
                $campo_de_futebol = '';
            endif;
            ...
            if($lotes->churrasqueira):
                 $churrasqueira = 'checked';
            else:
                $churrasqueira = '';
            endif;
            ...
            if($lotes->piscina_infantil):
                 $piscina_infantil = 'checked';
            else:
                $piscina_infantil = '';
            endif;
            ...
            if($lotes->pista_de_skate):
                 $pista_de_skate = 'checked';
            else:
                $pista_de_skate = '';
            endif;
            ...
            if($lotes->quadra_de_futsal):
                 $quadra_de_futsal = 'checked';
            else:
                $quadra_de_futsal = '';
            endif;
            ...
            if($lotes->quadra_de_squash):
                 $quadra_de_squash = 'checked';
            else:
                $quadra_de_squash = '';
            endif;
            ...
            if($lotes->quadra_de_tenis):
                 $quadra_de_tenis = 'checked';
            else:
                $quadra_de_tenis = '';
            endif;
            ...
            if($lotes->sala_de_massagem):
                 $sala_de_massagem = 'checked';
            else:
                $sala_de_massagem = '';
            endif;
            ...
            if($lotes->salao_de_beleza):
                 $salao_de_beleza = 'checked';
            else:
                $salao_de_beleza = '';
            endif;
            ...
            if($lotes->salao_de_festas):
                 $salao_de_festas = 'checked';
            else:
                $salao_de_festas = '';
            endif;
            ...
            if($lotes->salao_de_festas_infantil):
                 $salao_de_festas_infantil = 'checked';
            else:
                $salao_de_festas_infantil = '';
            endif;



            if($lotes->salao_de_jogos):
                 $salao_de_jogos = 'checked';
            else:
                $salao_de_jogos = '';
            endif;
            ...
            if($lotes->vagas_de_visitantes):
                 $vagas_de_visitantes = 'checked';
            else:
                $vagas_de_visitantes = '';
            endif;
            ...
            if($lotes->vagas_de_visitantes == 1):
                $arrcheck['vagas_de_visitantes'] = 'checked';

                else:
                    $arrcheck['vagas_de_visitantes'] = '';
            ...
            if($lotes->salao_de_jogos == 1):
                $arrcheck['salao_de_jogos'] = 'checked';

                else:
                    $arrcheck['salao_de_jogos'] = '';

            endif;



            if($lotes->salao_de_festas_infantil == 1):
                $arrcheck['salao_de_festas_infantil'] = 'checked';

                else:
                    $arrcheck['salao_de_festas_infantil'] = '';

            endif;



            if($lotes->salao_de_festas == 1):
                $arrcheck['salao_de_festas'] = 'checked';

                else:
                    $arrcheck['salao_de_festas'] = '';

            endif;



            if($lotes->salao_de_beleza == 1):
                $arrcheck['salao_de_beleza'] = 'checked';

                else:
                    $arrcheck['salao_de_beleza'] = '';

            endif;



            if($lotes->sala_de_massagem == 1):
                $arrcheck['sala_de_massagem'] = 'checked';

                else:
                    $arrcheck['sala_de_massagem'] = '';

            endif;



            if($lotes->restaurante == 1):
                $arrcheck['restaurante'] = 'checked';

                else:
                    $arrcheck['restaurante'] = '';

            endif;



            if($lotes->quadra_de_tenis == 1):
                $arrcheck['quadra_de_tenis'] = 'checked';

                else:
                    $arrcheck['quadra_de_tenis'] = '';

            endif;



            if($lotes->quadra_de_squash == 1):
                $arrcheck['quadra_de_squash'] = 'checked';

                else:
                    $arrcheck['quadra_de_squash'] = '';

            endif;


            if($lotes->quadra_de_futsal == 1):
                $arrcheck['quadra_de_futsal'] = 'checked';

                else:
                    $arrcheck['quadra_de_futsal'] = '';

            endif;


            if($lotes->playground == 1):
                $arrcheck['playground'] = 'checked';
            ...
            if($lotes->pista_de_skate == 1):
                $arrcheck['pista_de_skate'] = 'checked';

                else:
                    $arrcheck['pista_de_skate'] = '';

            endif;


            if($lotes->piscina_infantil == 1):
                $arrcheck['piscina_infantil'] = 'checked';

                else:
                    $arrcheck['piscina_infantil'] = '';

            endif;


            if($lotes->piscina == 1):
                $arrcheck['piscina'] = 'checked';
            ...
            if($lotes->churrasqueira == 1):
                $arrcheck['churrasqueira'] = 'checked';

                else:
                    $arrcheck['churrasqueira'] = '';

            endif;


            if($lotes->campo_de_futebol == 1):
                $arrcheck['campo_de_futebol'] = 'checked';

                else:
                    $arrcheck['campo_de_futebol'] = '';

            endif;


            if($lotes->brinquedoteca == 1):
                $arrcheck['brinquedoteca'] = 'checked';

                else:
                    $arrcheck['brinquedoteca'] = '';

            endif;


            if($lotes->bicicletario == 1):
                $arrcheck['bicicletario'] = 'checked';

                else:
                    $arrcheck['bicicletario'] = '';

            endif;


            if($lotes->academia == 1):
                $arrcheck['academia'] = 'checked';
        ...
        $mysql->filtro = "WHERE `status` = 1";
        $categoria = $mysql->read('lotes1_cate');
        ...
        foreach ($categoria as $value){
            ...
            if($categoria > 0 and $categoria == $value->id):
                $opcate .= '<option value="'.$value->id.'" selected>'.$value->nome.'</option>';

            else:
                    $opcate .= '<option value="'.$value->id.'">'.$value->nome.'</option>';
        ...
        $mysql->filtro = "WHERE `status` = 1";
        $leilao = $mysql->read('leiloes');

        foreach ($leilao as $value){


            if($leiloess > 0 and $leiloess == $value->id):
                $opleilao .= '<option value="'.$value->id.'" selected>'.$value->nome.'</option>';

            else:
                $opleilao .= '<option value="'.$value->id.'">'.$value->nome.'</option>';

            endif;

        }

            $conteudo = '<ul class="campos box"> <li tabs="tabs_0" class="ativo"> 
 <ul class="itens"> <div class="conteudo_ini"></div>
  <div class="pl10 "> <fieldset class="w100p fll pt5 pb5 pr10 mt5 mb5 br1 "> 
   
   <li class="wr12 linhas_inputs text "> 
   
    <div class="finput finput_nome"> 
    <label class="lnome" for="nome">  
    <p> Nome<span class="c_vermelho">*</span>: </p>   
    </label> <div class="input" rel="tooltip" data-original-title="">   
    <input type="text" name="nome" id="nome" class="design " required="" value="'.$nome.'"> </div>  
    </div>
 <div class="clear"></div>  </li>  
 
 
 <li class="wr6 linhas_inputs text "> 
 
 <div class="finput finput_nome_meta"> 
 
 <label class="lnome" for="nome_meta"> <p> Meta (Titulo do Site): </p> </label>
  
  <div class="input" rel="tooltip" data-original-title=""> 
  
  <input type="text" name="nome_meta" id="nome_meta" value="'.$nome_meta.'" class="design " > 
  
  </div></div>
 <div class="clear"></div>  </li> 

      <li class="wr6 linhas_inputs file "> 
     
      <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
      
      <label class="lnome" for="google_maps"> <p> Categorias: </p> </label>
<div class="input" rel="tooltip" data-original-title=""> <div class="posr">

<select class="design" name="categorias">
'.$opcate.'
</select>
 ...
 <div class="clear"></div>  </li> 
   ...
   <span class="vm c-p limit"> <i class="fa fa-file-image-o ml2 mr3 c_cinza8 "></i> <span>Selecionar Arquivo</span> </span> 
   <input type="file" name="foto" id="foto" class="design " onchange="input_file(this)">
    </label> 
    </div>
 <div class="clear"></div>  </li>
      ...
      <li class="wr6 linhas_inputs file "> <div class="finput finput_foto" rel="tooltip" data-original-title=""> <label class="lnome" for="google_maps"> <p> Leilão: </p> </label>
<div class="input" rel="tooltip" data-original-title=""> <div class="posr">

<select class="design" name="leiloes">
'.$opleilao.'
</select>
 ...
 <div class="clear"></div>  </li>
   ...
   <li class="wr6 linhas_inputs text ">
    ...
    <div class="finput finput_data_ini"> 
    <label class="lnome" for="data_ini"> <p> Data Inicio<span class="c_vermelho">*</span>: </p> </label> 
    
    <div class="input" rel="tooltip" data-original-title="">
     
     <input type="datetime-local" name="data_ini" id="data_ini" class="design " required="" value="'.$data_ini.'"> 
     
     </div>
     </div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text ">
  
  <div class="finput finput_data_fim"> <label class="lnome" for="data_fim"> <p> Data Fim<span class="c_vermelho">*</span>: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="datetime-local" name="data_fim" id="data_fim" class="design " required="" value="'.$data_fim.'"> </div></div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text "> <div class="finput finput_lance_ini"> <label class="lnome" for="lance_ini"> <p> Lance Inicial<span class="c_vermelho">*</span>: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="search" name="lance_ini" id="lance_ini" value="'.$lance_ini.'" class="design preco" required=""> </div></div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text "> <div class="finput finput_lance_min"> <label class="lnome" for="lance_min"> <p> Lance Minimo<span class="c_vermelho">*</span>: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="search" name="lance_min" id="lance_min" value="'.$lance_min.'" class="design preco" required=""> </div></div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text "> <div class="finput finput_data_ini1"> <label class="lnome" for="data_ini1"> <p> Data Inicio (2ª Praça): </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="datetime-local" name="data_ini1" id="data_ini1" class="design " value="erroTerro"> </div></div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text "> <div class="finput finput_data_fim1"> <label class="lnome" for="data_fim1"> <p> Data Fim (2ª Praça): </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="datetime-local" name="data_fim1" id="data_fim1" class="design " value="erroTerro"> </div></div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text "> <div class="finput finput_lance_min1"> <label class="lnome" for="lance_min1"> <p> Lance Minimo (2ª Praça): </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="search" name="lance_min1" id="lance_min1" class="design preco"> </div></div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text "> <div class="finput finput_comissao"> <label class="lnome" for="comissao"> <p> Comissão do Leiloeiro: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="number" name="comissao" id="comissao"  value="'.$comissao.'" class="design " min="0" max="1000"> </div></div>

 <div class="clear"></div>  </li>  <li class="wr4 linhas_inputs text "> <div class="finput finput_incremento"> <label class="lnome" for="incremento"> <p> Incremento: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="search" name="incremento" id="incremento" value="'.$incremento.'" class="design preco"> </div></div>

 <div class="clear"></div>  </li>  <li class="wr4 linhas_inputs text "> <div class="finput finput_acrescimo"> <label class="lnome" for="acrescimo"> <p> Acréscimo: </p> </label> <div class="input" rel="tooltip" data-original-title="Segundos"> <input type="number" name="acrescimo" id="acrescimo"  value="'.$acrescimo.'" class="design " value="0" min="0"> </div></div>

 <div class="clear"></div>  </li>
    <li class="wr4 linhas_inputs text "> <div class="finput finput_cep"> <label class="lnome" for="cep"> <p> CEP: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="cep" id="cep" class="design "  value="'.$cep.'" onblur="cepp(this)"> </div></div>

 <div class="clear"></div>  </li>
 
 <li class="wr6 linhas_inputs file "> <div class="finput finput_cep"> <label class="lnome" for="cep"> <p> Bairro: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="bairro" id="bairros" class="design "  value="'.$bairro.'"> </div></div>

 <div class="clear"></div> 

 <div class="clear"></div>  </li> 
 
    <li class="wr6 linhas_inputs text "> <div class="finput finput_endereco"> <label class="lnome" for="endereco"> <p> Endereço: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="endereco" id="rua" class="design "  value="'.$endereco.'"> </div></div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text "> <div class="finput finput_incremento"> <label class="lnome" for="estados"> <p> Estado: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="estados" id="estados"  value="'.$estados.'" class="design"> </div></div>

 <div class="clear"></div>  </li> <li class="wr6 linhas_inputs text "> <div class="finput finput_incremento"> <label class="lnome" for="cidades"> <p> Cidade: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="cidades" id="cidades" value="'.$cidades.'" class="design"> </div></div>

 <div class="clear"></div>  </li> 
   <li class="wr6 linhas_inputs text "> <div class="finput finput_incremento"> <label class="lnome" for="area_privativa"> <p> Área Privativa: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="number" name="area_privativa" id="area_privativa" value="'.$area_privativa.'" class="design"> </div></div>

 <div class="clear"></div>  </li>
 
    <li class="wr6 linhas_inputs text "> <div class="finput finput_incremento"> <label class="lnome" for="quartos"> <p> Quartos: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="number" name="quartos" id="quartos" value="'.$quartos.'" class="design"> </div></div>

 <div class="clear"></div>  </li>
 
     <li class="wr4 linhas_inputs file "> 
     
      <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
      
      <label class="lnome" for="google_maps"> <p> Fase da Obra: </p> </label>
<div class="input" rel="tooltip" data-original-title=""> <div class="posr">

<select class="design" name="fase_da_obra">
<option value="1" '.$faseobra[1].'>Breve lançamento</option>
<option value="2" '.$faseobra[2].'>Lançamento</option>
<option value="3" '.$faseobra[3].'>Em construção</option>
<option value="4" '.$faseobra[4].'>Pronto</option>
</select>
 ...
 <div class="clear"></div>  </li> 
    ...
    <li class="wr4 linhas_inputs file "> 
      ...
      <label class="lnome" for="google_maps"> <p> Desocupado: </p> </label>
<div class="input" rel="tooltip" data-original-title=""> <div class="posr">

<select class="design" name="desocupado">
<option value="1" '.$desocupado[1].'>Sim</option>
<option value="0" '.$desocupado[2].'>Não</option>
 ...
 <div class="clear"></div>  </li> 
   ...
   <li class="wr4 linhas_inputs text "> <div class="finput finput_incremento"> <label class="lnome" for="suites"> <p> Suites: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="number" name="suites" id="suites" value="'.$suite.'" class="design"> </div></div>

 <div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Academia: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="academia"  id="Academia" class="design " value="1" '.$arrcheck['academia'].'> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="bicicletario"> <p> Bicicletário: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="bicicletario"  id="bicicletario" '.$arrcheck['bicicletario'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="brinquedoteca"> <p> Brinquedoteca: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="brinquedoteca"  id="brinquedoteca" '.$arrcheck['brinquedoteca'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="campo_de_futebol"> <p> Campo de Futebol: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="campo_de_futebol"  id="campo_de_futebol" '.$arrcheck['campo_de_futebol'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="churrasqueira"> <p> Churrasqueira: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="churrasqueira"  id="churrasqueira" '.$arrcheck['churrasqueira'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="cinema"> <p> Cinema: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="cinema"  id="cinema" '.$arrcheck['cinema'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="pet_care"> <p> Pet Care: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="pet_care"  id="pet_care" '.$arrcheck['pet_care'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="piscina"> <p> Piscina: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="piscina"  id="piscina" '.$arrcheck['piscina'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="piscina_infantil"> <p> Piscina Infantil : </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="piscina_infantil" '.$arrcheck['piscina_infantil'].'  id="piscina_infantil" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="pista_de_skate"> <p> Pista de Skate: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="pista_de_skate"  id="pista_de_skate" '.$arrcheck['pista_de_skate'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="playground"> <p> Playground: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="playground"  id="playground" '.$arrcheck['playground'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="quadra_de_futsal"> <p> Quadra de Futsal: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="quadra_de_futsal" '.$arrcheck['quadra_de_futsal'].'  id="quadra_de_futsal" class="design " value="1"> </div></div><div class="clear"></div>  </li>
  
 
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="quadra_de_squash"> <p> Quadra de Squash: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="quadra_de_squash" '.$arrcheck['quadra_de_squash'].'  id="quadra_de_squash" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="quadra_de_tenis"> <p> Quadra de tênis: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="quadra_de_tenis" '.$arrcheck['quadra_de_tenis'].' id="quadra_de_tenis" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="restaurante"> <p> Restaurante: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="restaurante"  id="restaurante" '.$arrcheck['restaurante'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="sala_de_massagem"> <p> Sala de Massagem: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="sala_de_massagem"  id="sala_de_massagem" '.$arrcheck['sala_de_massagem'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="salao_de_beleza"> <p> Salão de Beleza: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="salao_de_beleza"  id="salao_de_beleza" '.$arrcheck['salao_de_beleza'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="salao_de_festas"> <p> Salão de Festas: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="salao_de_festas"  id="salao_de_festas" '.$arrcheck['salao_de_festas'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="salao_de_festas_infantil"> <p> Salão de Festas Infantil: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="salao_de_festas_infantil"  id="salao_de_festas_infantil"  '.$arrcheck['salao_de_festas_infantil'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="salao_de_jogos"> <p> Salão de Jogos: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="salao_de_jogos"  id="salao_de_jogos" '.$arrcheck['salao_de_jogos'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="sauna"> <p> Sauna : </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="sauna"  id="sauna" '.$arrcheck['sauna'].'  class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="spa"> <p> Spa: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="spa"  id="spa" '.$arrcheck['spa'].' '.$arrcheck['spa'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="vagas_de_visitantes"> <p> Vagas de Visitantes: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="vagas_de_visitantes"  id="vagas_de_visitantes" '.$arrcheck['vagas_de_visitantes'].' class="design " value="1"> </div></div><div class="clear"></div>  </li>
 
 
  <li class="wr12 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="google_maps"> <p> Google Maps: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="google_maps" value="'.$google_maps.'" id="google_maps" class="design "> </div></div>

 <div class="clear"></div>  </li>  <li class="wr12 linhas_inputs text "> <div class="finput finput_obs"> <label class="lnome" for="obs"> <p> Observação: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="obs" id="obs" value="'.$obs.'" class="design "> </div></div>

 <div class="clear"></div>  </li>  </fieldset> <div class="clear"></div> </div>  <div class="pl10 "> <fieldset class="w100p fll pt5 pb5 pr10 mt5 mb5 br1 "> <legend class="pl5 pr5 ml5 mr5">Anexos</legend> <li class="wr12 linhas_inputs file "> <div class="finput finput_foto10" rel="tooltip" data-original-title=""> <label for="foto10"> <p> Edital: </p> </label> <label for="foto10" class="input file"> <span class="vm c-p limit"> <i class="fa fa-file-image-o ml2 mr3 c_cinza8 "></i> <span>Selecionar Arquivo</span> </span> <input type="file" name="foto10" id="foto10" class="design " onchange="input_file(this)"> </label> </div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs file "> <div class="finput finput_foto1" rel="tooltip" data-original-title=""> <label for="foto1"> <p> Arquivo 01: </p> </label> <label for="foto1" class="input file"> <span class="vm c-p limit"> <i class="fa fa-file-image-o ml2 mr3 c_cinza8 "></i> <span>Selecionar Arquivo</span> </span> <input type="file" name="foto1" id="foto1" class="design " onchange="input_file(this)"> </label> </div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text "> <div class="finput finput_anexo1"> <label class="lnome" for="anexo1"> <p> Anexo 01: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="anexo1" id="anexo1"  class="design "> </div></div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs file "> <div class="finput finput_foto2" rel="tooltip" data-original-title=""> <label for="foto2"> <p> Arquivo 02: </p> </label> <label for="foto2" class="input file"> <span class="vm c-p limit"> <i class="fa fa-file-image-o ml2 mr3 c_cinza8 "></i> <span>Selecionar Arquivo</span> </span> <input type="file" name="foto2" id="foto2" class="design " onchange="input_file(this)"> </label> </div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text "> <div class="finput finput_anexo2"> <label class="lnome" for="anexo2"> <p> Anexo 02: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="anexo2" id="anexo2" class="design "> </div></div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs file "> <div class="finput finput_foto3" rel="tooltip" data-original-title=""> <label for="foto3"> <p> Arquivo 03: </p> </label> <label for="foto3" class="input file"> <span class="vm c-p limit"> <i class="fa fa-file-image-o ml2 mr3 c_cinza8 "></i> <span>Selecionar Arquivo</span> </span> <input type="file" name="foto3" id="foto3" class="design " onchange="input_file(this)"> </label> </div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text "> <div class="finput finput_anexo3"> <label class="lnome" for="anexo3"> <p> Anexo 03: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="anexo3" id="anexo3" class="design "> </div></div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs file "> <div class="finput finput_foto4" rel="tooltip" data-original-title=""> <label for="foto4"> <p> Arquivo 04: </p> </label> <label for="foto4" class="input file"> <span class="vm c-p limit"> <i class="fa fa-file-image-o ml2 mr3 c_cinza8 "></i> <span>Selecionar Arquivo</span> </span> <input type="file" name="foto4" id="foto4" class="design " onchange="input_file(this)"> </label> </div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text "> <div class="finput finput_anexo4"> <label class="lnome" for="anexo4"> <p> Anexo 04: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="anexo4" id="anexo4" class="design "> </div></div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs file "> <div class="finput finput_foto5" rel="tooltip" data-original-title=""> <label for="foto5"> <p> Arquivo 05: </p> </label> <label for="foto5" class="input file"> <span class="vm c-p limit"> <i class="fa fa-file-image-o ml2 mr3 c_cinza8 "></i> <span>Selecionar Arquivo</span> </span> <input type="file" name="foto5" id="foto5" class="design " onchange="input_file(this)"> </label> </div>

 <div class="clear"></div>  </li>  <li class="wr6 linhas_inputs text "> <div class="finput finput_anexo5"> <label class="lnome" for="anexo5"> <p> Anexo 05: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="anexo5" id="anexo5" class="design "> </div></div>

 <div class="clear"></div>  </li>  </fieldset> <div class="clear"></div> </div>  <div class="pl10 "> <fieldset class="w100p fll pt5 pb5 pr10 mt5 mb5 br1 "> <legend class="pl5 pr5 ml5 mr5">Meta (Descrição)</legend> <li class="wr12 linhas_inputs textarea "> <div class="finput finput_txt_meta ftextarea pl10">  <div class="clear"></div> <div class="input dbi" rel="tooltip" data-original-title=""> <textarea name="txt_meta" id="txt_meta" class="design ">'.$txt_meta.'</textarea> </div> <div class="clear"></div> </div> 

 <div class="clear"></div>  </li>  <li class="wr12 linhas_inputs text "> <div class="finput finput_txt_extra_01"> <label class="lnome" for="txt_extra_01"> <p> Titulo da Descrição Extra 01: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="txt_extra_01" id="txt_extra_01" value="'.$txt_extra_01.'" class="design "> </div></div>

 <div class="clear"></div>  </li>  <li class="wr12 linhas_inputs text "> <div class="finput finput_txt_extra_02"> <label class="lnome" for="txt_extra_02"> <p> Titulo da Descrição Extra 02: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="txt_extra_02" id="txt_extra_02" value="'.$txt_extra_02.'" class="design "> </div></div>

 <div class="clear"></div>  </li>  <li class="wr12 linhas_inputs text "> <div class="finput finput_txt_extra_03"> <label class="lnome" for="txt_extra_03"> <p> Titulo da Descrição Extra 03: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="txt_extra_03" id="txt_extra_03" value="'.$txt_extra_03.'" class="design "> </div></div>

 <div class="clear"></div>  </li> <div class="conteudo_fim"></div> 	<div class="clear"></div>  </fieldset></div></ul>  <div class="h5 clear"></div> </li> </ul>';
...
function conteudo_da_pagina($conteudo, $modulos, $ids, $modulos_abas, $modulos_campos, $linhas)
{
    ...
    foreach ($modulos_abas as $kabas => $value_abas) {
        ...
        if (isset($modulos_campos[$kabas])) {
            $return .= replace_lote($modulos,$modulos_abas,$linhas,campos_das_paginas($modulos_campos[$kabas], $kabas, $linhas));
        }
...
function datatable_acoes($modulos, $datatables_top, $datatables_center)
{
    ...
    if ($modulos->id == 60) {
        $return .= '<span type="button" class="fll botao novo" onclick="importarLotes();"> <i class="icon mr5 fa fa-file c_verde"></i> Importar Lotes </span> ';
        $return .= '<span type="button" class="fll botao novo" onclick="importarValor();" style="display:none;"> <i class="icon mr5 fa fa-file c_verde"></i> Importar Valores </span> ';
        $return .= '<span type="button" class="fll botao novo" onclick="importarDesc();"> <i class="icon mr5 fa fa-file c_verde"></i> Importar Descrição </span> ';
        $mysql = new Mysql();

        $leilao = '';

        $mysql->filtro = " WHERE `status` = 1 ";
        $leileoszsz = $mysql->read('leiloes');
        foreach ($leileoszsz as $valuesss){

            $leilao .= '<option value="">Selecione o Leilão</option>';
            $leilao .= '<option name="'.$valuesss->id.'" value="'.$valuesss->id.'">'.$valuesss->nome.'</option>';
        }

        $campotroca = "'#campoTroca'";
        $return .= '
                <script>
                function SubmitPasta(id) {
                  $("#campoTroca").text(id);
                }
                
                
                  function closeimportarLotes() {

                    $("#importador").css("display","none");

                }
                function importarLotes() {

                    $("#importador").css("display","block");

                }   
                  function closeimportarDesc() {

                    $("#importadordesc").css("display","none");

                }
                function importarDesc() {

                    $("#importadordesc").css("display","block");
                ...
                margin-top: -140px;
                            ...
                            <div class="modal-importador" id="importador">
                            <a href="javascript:closeimportarLotes();" id="closeTimes"><b><i class="fa fa-2x fa-times"></i></b></a>
                            
                            
                            <br>
                            <br>
                            <br>
                            <form method="post" enctype="multipart/form-data" action="/importarLotes.php">
                            
                            <h2 style="text-align: center;">Importar na Pasta: /web/fotos/leilao<span id="campoTroca"></span>/</h2>
                            <label for="EnviarArquivo" style="font-size: 20pt;text-align: center;float: left;width: 100%;">Importar Lotes
                          <br>
                            <input class="" type="file" id="EnviarArquivo" name="EnviarArquivo" />
                            </label>
                            
                            <br> <br>                            <br> <br>

      <label for="datainicio" style="font-size: 20pt;text-align: center;float: left;width: 100%;"> Data inicio
                          <br>
                            <input class="design" type="datetime-local" id="datainicio" name="data_ini" />
                            </label>
                            ...
                            <br> <br>
                                  ...
                                  <label for="datafim" style="font-size: 20pt;text-align: center;float: left;width: 100%;"> Data Fim
                          <br>
                            <input class="design" type="datetime-local" id="datafim" name="data_fim" />
                            </label>
                               <br> <br>
                            
                            <br> <br>
                            
                     <input class="design" type="hidden" id="NumeroColunas" name="colunas" value="10" />
                                  ...
                                  <label for="NumeroRegistro" style="font-size: 20pt;text-align: center;float: left;width: 100%;"> Numero de Registros
                          <br>
                            <input class="design" type="number" name="registro" id="NumeroRegistro"/>
                            </label>
                            
                            <br> <br>
                            <br> <br>
                         <label for="selecionarLeilao" style="font-size: 20pt;text-align: center;float: left;width: 100%;">Selecionar o Leilão
                            <br><select name="leilao" onchange="SubmitPasta(this.value);" class="" style="padding: 1%;">
                            ...
                            <br><br>
                                  ...
                                  <label for="localidade" style="font-size: 20pt;text-align: center;float: left;width: 100%;"> Cidade
                          <br>
                            <input class="design" type="text" name="localidade" id="localidade"/>
                            </label>
                            
                            <br> <br>
                                  <label for="estado" style="font-size: 20pt;text-align: center;float: left;width: 100%;"> Estado
                          <br>
                            <input class="design" type="text" name="estado" id="estado"/>
                            </label>
                            
                            <br> <br>
                            <button type="submit" style="padding: 1%;text-align: center;float: left;width: 100%;margin-top: 20px;">IMPORTAR LOTES</button>
                            </form>
</div>    
  
  
  <div class="modal-importador" id="importadordesc">
                            <a href="javascript:closeimportarDesc();" id="closeTimes"><b><i class="fa fa-2x fa-times"></i></b></a>
                            
                            
                            <br>
                            <br>
                            <br>
                            <form method="post" enctype="multipart/form-data" action="/importar_descritivo.php">
                              <br> <br>
                         <label for="selecionarLeilao" style="font-size: 20pt;text-align: center;float: left;width: 100%;">Selecionar o Leilão
                            <br><select name="leilao" onchange="SubmitPasta(this.value);" class="" style="padding: 1%;">
                            ...
                            <br><br>
                            <label for="EnviarArquivo" style="font-size: 20pt;text-align: center;float: left;width: 100%;">Importar Descritivo
                          <br>
                            <input class="" type="file" id="EnviarArquivo" name="EnviarArquivo" />
                            </label>
                            ...
                            <button type="submit" style="padding: 1%;text-align: center;float: left;width: 100%;margin-top: 20px;">IMPORTAR DESCRIÇÃO</button>
                            </form>
</div>
 ';
        ...
        $return .= '
                <script>
                  function closeimportarValor() {

                    $("#importadorvlr").css("display","none");

                }
                function importarValor() {

                    $("#importadorvlr").css("display","block");
                ...
                margin-top: -140px;
                            ...
                            <div class="modal-importadorvlr" id="importadorvlr" style="display:none;">
                            <a href="javascript:closeimportarValor();" id="closeTimes"><b><i class="fa fa-2x fa-times"></i></b></a>
                            
                            
                            <br>
                            <br>
                            <br>
                            <form method="post" enctype="multipart/form-data" action="/importarValores.php">
                            <label for="EnviarArquivo" style="font-size: 20pt;text-align: center;float: left;width: 100%;">Importar Valores
                          <br>
                            <input class="" type="file" id="EnviarArquivo" name="EnviarArquivo" />
                            </label>
                     ...
                     <input class="design" type="hidden" id="NumeroColunas" name="colunas" value="10" />
                          ...
                          <br>
                            ...
                            <br> <br>
                         <label for="selecionarLeilao" style="font-size: 20pt;text-align: center;float: left;width: 100%;">Selecionar o Leilão
                            <br><select name="leilao" class="" style="padding: 1%;">
                            ...
                            <br><br>
                            <button type="submit" style="padding: 1%;text-align: center;float: left;width: 100%;margin-top: 20px;">IMPORTAR VALORES</button>
                            </form>
</div>
 ';
...
function datatable_ordenacao($datatables_center, $table_ordem = '')
{
    ...
    if ($table_ordem) $return = $table_ordem . ', ' . $return;
    return ($return);
}
