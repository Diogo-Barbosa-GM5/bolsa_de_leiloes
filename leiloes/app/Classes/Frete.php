<?
	...
	class Frete extends Mysql {
		...
		public function correios(){	
			...
			if($this->comprimento<16)	$this->comprimento = 16;		if($this->comprimento>105)	$this->comprimento = 105;
			if($this->largura<12)		$this->largura = 12;			if($this->largura>105)		$this->largura = 99;
			if($this->altura<2)			$this->altura = 2;				if($this->altura>105)		$this->altura = 99;
