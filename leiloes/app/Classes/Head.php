<?
	...
	class Head extends Mysql {
		...
		public function css(){
			...
			// JQuery - jquery-ui.css incuído por Diogo
            $return .= '<link rel="stylesheet" type="text/css" href="'.DIR.'/plugins/Jquery/UI/css/jquery-ui.css" />'.$this->quebra;
		...
		public function js(){
			// Jquery
			$return = '<script type="text/javascript" src="'.DIR.'/js/jquery-1.11.3.min.js"></script> '.$this->quebra;
			$return .= '<script type="text/javascript" src="'.DIR.'/plugins/Jquery/jquery.form.js"></script> '.$this->quebra;
			$return .= '<script type="text/javascript" src="'.DIR.'/js/jquery-ui.js"></script> '.$this->quebra;
			$return .= '<script type="text/javascript" src="'.DIR.'/js/less.js"></script> '.$this->quebra;
		...
		public function meta(){
			...
			$google = $this->read('configs');
                ...
                $return .= '<meta name="robots" content="noindex" />'.$this->quebra;
                //$return .= '<meta name="googlebot" content="noindex">'.$this->quebra;
                //$return .= '<meta name="MSNBot" content="noindex" />'.$this->quebra;
