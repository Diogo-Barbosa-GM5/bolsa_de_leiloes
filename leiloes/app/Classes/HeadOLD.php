<?
	...
	class Head extends Mysql {
		...
		public function js(){
			// Jquery
			$return = '<script type="text/javascript" src="https://code.jquery.com/jquery-1.11.3.min.js"></script> '.$this->quebra;
			$return .= '<script type="text/javascript" src="'.DIR.'/plugins/Jquery/jquery.form.js"></script> '.$this->quebra;
			$return .= '<script type="text/javascript" src="https://code.jquery.com/ui/1.11.3/jquery-ui.js"></script> '.$this->quebra;
			$return .= '<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/less.js/3.0.4/less.js"></script> '.$this->quebra;
