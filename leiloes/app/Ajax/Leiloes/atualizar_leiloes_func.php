...
function informacoes($leiloes, $lotes, $value, $dados, $lote=0){
    ...
    $dados['vagas'] = empty($value->vagas) ? 0 : $value->vagas; // Incluído por Diogo 12/09/2019
    $dados['lances'] = $value->lances; // Incluído por Diogo 12/09/2019

    switch ($value->fase_da_obra) {
        case 1:
            $dados['fase_da_obra'] = 'Breve lançamento';
          break;
        case 2:
            $dados['fase_da_obra'] = 'Lançamento';
          break;
        case 3:
            $dados['fase_da_obra'] = 'Em construção';
          break;
        case 4:
            $dados['fase_da_obra'] = 'Pronto';
          break;
    }
