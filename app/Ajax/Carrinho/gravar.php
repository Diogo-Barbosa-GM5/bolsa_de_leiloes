<?	ob_start();
	...
	$arr['topo'] = '';
		...
		if($_POST['id']){
			...
			if(isset($_POST['cores']) AND $_POST['cores'] AND isset($_POST['tamanhos']) AND  $_POST['tamanhos']){
			...
			if($qtd and $estoque >= $qtd){
				...
				$ref = $_POST['id'].'_'.$_POST['cores'].'_'.$_POST['tamanhos'].'_'.$_POST['opcoes1'].'_'.$_POST['opcoes2'].'_'.$_POST['opcoes3'].'_'.$_POST['opcoes4'].'_'.$_POST['opcoes5'].'_';
				$arr['ref'] = $ref;
