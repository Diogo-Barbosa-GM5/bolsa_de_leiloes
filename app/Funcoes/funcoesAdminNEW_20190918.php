...
function replace_lote($modulos,$modulos_abas,$linhas,$conteudo){
    ...
    if($modulos->id == 60):
        ...
        if($linhas->id > 0):
            ...
            $lance_ini = str_replace('.','',$lotes->lance_ini);
            $lance_min = str_replace('.','',$lotes->lance_min);
...
<option value="2" '.$desocupado[2].'>Não</option>
 ...
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Academia: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="academia"  id="Academia" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Bicicletário: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="bicicletario"  id="bicicletario" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Brinquedoteca: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="brinquedoteca"  id="brinquedoteca" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Campo de Futebol: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="campo_de_futebol"  id="campo_de_futebol" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Churrasqueira: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="churrasqueira"  id="churrasqueira" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Cinema: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="cinema"  id="cinema" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Pet Care: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="pet_care"  id="pet_care" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Piscina: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="piscina"  id="piscina" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Piscina Infantil : </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="piscina_infantil"  id="piscina_infantil" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Pista de Skate: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="pista_de_skate"  id="pista_de_skate" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Playground: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="playground"  id="playground" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Quadra de Futsal: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="quadra_de_futsal"  id="quadra_de_futsal" class="design " value="1"> </div></div><div class="clear"></div>  </li>
  
 
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Quadra de Squash: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="quadra_de_squash"  id="quadra_de_squash" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Quadra de tênis: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="quadra_de_tenis"  id="quadra_de_tenis" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Restaurante: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="restaurante"  id="restaurante" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Sala de Massagem: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="sala_de_massagem"  id="sala_de_massagem" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Salão de Beleza: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="salao_de_beleza"  id="salao_de_beleza" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Salão de Festas: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="salao_de_festas"  id="salao_de_festas" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Salão de Festas Infantil: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="salao_de_festas_infantil"  id="salao_de_festas_infantil" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Salão de Jogos: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="salao_de_jogos"  id="salao_de_jogos" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Sauna : </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="sauna"  id="sauna" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Spa: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="spa"  id="spa" class="design " value="1"> </div></div><div class="clear"></div>  </li>
 <li class="wr2 linhas_inputs text "> <div class="finput finput_google_maps"> <label class="lnome" for="Academia"> <p> Vagas de Visitantes: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="checkbox" name="vagas_de_visitantes"  id="vagas_de_visitantes" class="design " value="1"> </div></div><div class="clear"></div>  </li>
