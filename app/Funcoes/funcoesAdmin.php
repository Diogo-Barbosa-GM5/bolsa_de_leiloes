...
function replace_lote($modulos,$modulos_abas,$linhas,$conteudo){
    ...
    if($modulos->id == 60):
        ...
        if($linhas->id > 0):
            ...
            $mysql->prepare = array($linhas->id);
            $mysql->filtro = "WHERE `item` = ? AND tabelas = 'lotes' AND tipo = '0'";
            $z_txt = $mysql->read_unico('z_txt');


            $descricao = base64_decode($z_txt->txt);



            $mysql->prepare = array($linhas->id);
            $mysql->filtro = "WHERE `item` = ? AND tabelas = 'lotes' AND tipo = '1'";
            $z_txt = $mysql->read_unico('z_txt');


            $descricao1 = base64_decode($z_txt->txt);



            $mysql->prepare = array($linhas->id);
            $mysql->filtro = "WHERE `item` = ? AND tabelas = 'lotes' AND tipo = '2'";
            $z_txt = $mysql->read_unico('z_txt');


            $descricao2 = base64_decode($z_txt->txt);
            ...
            if($lotes->bicicletario):
                $bicicletario[1] = 'selected';
                $bicicletario[2] = '';
            else:
                $bicicletario[1] = '';
                $bicicletario[2] = 'selected';
            endif;



            if($lotes->brinquedoteca):
                $brinquedoteca[1] = 'selected';
                $brinquedoteca[2] = '';
            else:
                $brinquedoteca[1] = '';
                $brinquedoteca[2] = 'selected';
            ...
            if($lotes->campo_de_futebol):
                $campo_de_futebol[1] = 'selected';
                $campo_de_futebol[2] = '';
            else:
                $campo_de_futebol[1] = '';
                $campo_de_futebol[2] = 'selected';
            endif;



            if($lotes->churrasqueira):
                $churrasqueira[1] = 'selected';
                $churrasqueira[2] = '';
            else:
                $churrasqueira[1] = '';
                $churrasqueira[2] = 'selected';
            endif;
            ...
            if($lotes->piscina_infantil):
                $piscina_infantil[1] = 'selected';
                $piscina_infantil[2] = '';
            else:
                $piscina_infantil[1] = '';
                $piscina_infantil[2] = 'selected';
            endif;



            if($lotes->pista_de_skate):
                $pista_de_skate[1] = 'selected';
                $pista_de_skate[2] = '';
            else:
                $pista_de_skate[1] = '';
                $pista_de_skate[2] = 'selected';
            endif;



            if($lotes->playground):
                $playground[1] = 'selected';
                $playground[2] = '';
            else:
                $playground[1] = '';
                $playground[2] = 'selected';
            endif;



            if($lotes->quadra_de_futsal):
                $quadra_de_futsal[1] = 'selected';
                $quadra_de_futsal[2] = '';
            else:
                $quadra_de_futsal[1] = '';
                $quadra_de_futsal[2] = 'selected';
            endif;
            ...
            if($lotes->quadra_de_squash):
                $quadra_de_squash[1] = 'selected';
                $quadra_de_squash[2] = '';
            else:
                $quadra_de_squash[1] = '';
                $quadra_de_squash[2] = 'selected';
            endif;
            ...
            if($lotes->quadra_de_tenis):
                $quadra_de_tenis[1] = 'selected';
                $quadra_de_tenis[2] = '';
            else:
                $quadra_de_tenis[1] = '';
                $quadra_de_tenis[2] = 'selected';
            endif;



            if($lotes->restaurante):
                $restaurante[1] = 'selected';
                $restaurante[2] = '';
            else:
                $restaurante[1] = '';
                $restaurante[2] = 'selected';
            endif;
            ...
            if($lotes->sala_de_massagem):
                $sala_de_massagem[1] = 'selected';
                $sala_de_massagem[2] = '';
            else:
                $sala_de_massagem[1] = '';
                $sala_de_massagem[2] = 'selected';
            endif;
            ...
            if($lotes->salao_de_beleza):
                $salao_de_beleza[1] = 'selected';
                $salao_de_beleza[2] = '';
            else:
                $salao_de_beleza[1] = '';
                $salao_de_beleza[2] = 'selected';
            endif;
            ...
            if($lotes->salao_de_festas):
                $salao_de_festas[1] = 'selected';
                $salao_de_festas[2] = '';
            else:
                $salao_de_festas[1] = '';
                $salao_de_festas[2] = 'selected';
            endif;
            ...
            if($lotes->salao_de_festas_infantil):
                $salao_de_festas_infantil[1] = 'selected';
                $salao_de_festas_infantil[2] = '';
            else:
                $salao_de_festas_infantil[1] = '';
                $salao_de_festas_infantil[2] = 'selected';
            ...
            if($lotes->salao_de_jogos):
                $salao_de_jogos[1] = 'selected';
                $salao_de_jogos[2] = '';
            else:
                $salao_de_jogos[1] = '';
                $salao_de_jogos[2] = 'selected';
            ...
            if($lotes->vagas_de_visitantes):
                $vagas_de_visitantes[1] = 'selected';
                $vagas_de_visitantes[2] = '';

            else:
                $vagas_de_visitantes[1] = '';
                $vagas_de_visitantes[2] = 'selected';
...
<ul class="campos box"> <li tabs="tabs_0" class="ativo"> 
...
'.$opleilao.'
 ...
 <div class="clear"></div>  </li>
     ...
     <li class="wr3 linhas_inputs file "> 
...
<option value="0" '.$desocupado[2].'>Não</option>
 ...
 <div class="clear"></div>  </li> 
<li class="wr3 linhas_inputs text "> <div class="finput finput_incremento"> <label class="lnome" for="suites"> <p> Suites: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="number" name="suites" id="suites" value="'.$suite.'" class="design"> </div></div> <div class="clear"></div>  </li>



  <li class="wr3 linhas_inputs text "> <div class="finput finput_incremento"> <label class="lnome" for="vagas"> <p> Vagas: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="number" name="vagas" id="vagas" value="'.$vagas.'" class="design"> </div></div>
 ...
 <div class="clear"></div>  </li>
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Academia: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="academia">
                        <option value="0" '.$academia[2].'>Não</option>
                        <option value="1" '.$academia[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Bicicletário: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="bicicletario">
                        <option value="0" '.$bicicletario[2].'>Não</option>
                        <option value="1" '.$bicicletario[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Brinquedoteca: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="brinquedoteca">
                        <option value="0" '.$brinquedoteca[2].'>Não</option>
                        <option value="1" '.$brinquedoteca[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Campo de Futebol: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="campo_de_futebol">
                        <option value="0" '.$campo_de_futebol[2].'>Não</option>
                        <option value="1" '.$campo_de_futebol[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Churrasqueira: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="churrasqueira">
                        <option value="0" '.$churrasqueira[2].'>Não</option>
                        <option value="1" '.$churrasqueira[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Cinema: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="cinema">
                        <option value="0" '.$cinema[2].'>Não</option>
                        <option value="1" '.$cinema[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Pet Care: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="pet_care">
                        <option value="0" '.$pet_care[2].'>Não</option>
                        <option value="1" '.$pet_care[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Piscina: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="piscina">
                        <option value="0" '.$piscina[2].'>Não</option>
                        <option value="1" '.$piscina[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p>  Piscina Infantil: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="piscina_infantil">
                        <option value="0" '.$piscina_infantil[2].'>Não</option>
                        <option value="1" '.$piscina_infantil[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Pista de Skate: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="pista_de_skate">
                        <option value="0" '.$pista_de_skate[2].'>Não</option>
                        <option value="1" '.$pista_de_skate[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Playground: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="playground">
                        <option value="0" '.$playground[2].'>Não</option>
                        <option value="1" '.$playground[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Quadra de Futsal: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="quadra_de_futsal">
                        <option value="0" '.$quadra_de_futsal[2].'>Não</option>
                        <option value="1" '.$quadra_de_futsal[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Quadra de Squash: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="quadra_de_squash">
                        <option value="0" '.$quadra_de_squash[2].'>Não</option>
                        <option value="1" '.$quadra_de_squash[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Quadra de tênis: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="quadra_de_tenis">
                        <option value="0" '.$quadra_de_tenis[2].'>Não</option>
                        <option value="1" '.$quadra_de_tenis[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Restaurante: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="restaurante">
                        <option value="0" '.$restaurante[2].'>Não</option>
                        <option value="1" '.$restaurante[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Sala de Massagem: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="sala_de_massagem">
                        <option value="0" '.$sala_de_massagem[2].'>Não</option>
                        <option value="1" '.$sala_de_massagem[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Salão de Beleza: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="salao_de_beleza">
                        <option value="0" '.$salao_de_beleza[2].'>Não</option>
                        <option value="1" '.$salao_de_beleza[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Salão de Festas: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="salao_de_festas">
                        <option value="0" '.$salao_de_festas[2].'>Não</option>
                        <option value="1" '.$salao_de_festas[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Salão de Festas Infantil: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="salao_de_festas_infantil">
                        <option value="0" '.$salao_de_festas_infantil[2].'>Não</option>
                        <option value="1" '.$salao_de_festas_infantil[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Salão de Jogos: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="salao_de_jogos">
                        <option value="0" '.$salao_de_jogos[2].'>Não</option>
                        <option value="1" '.$salao_de_jogos[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Sauna: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="sauna">
                        <option value="0" '.$sauna[2].'>Não</option>
                        <option value="1" '.$sauna[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Spa: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="spa">
                        <option value="0" '.$spa[2].'>Não</option>
                        <option value="1" '.$spa[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
                   ...
                   <li class="wr3 linhas_inputs file "> 
                   <div class="finput finput_foto" rel="tooltip" data-original-title=""> 
                   <label class="lnome" for="google_maps"> <p> Vagas de Visitantes: </p> </label>
                   <div class="input" rel="tooltip" data-original-title=""> <div class="posr">
                        <select class="design" name="vagas_de_visitantes">
                        <option value="0" '.$vagas_de_visitantes[2].'>Não</option>
                        <option value="1" '.$vagas_de_visitantes[1].'>Sim</option>
                        </select>
                   </div>
                   </div>
                   </div> <div class="clear"></div>  </li> 
 ...
 <div class="clear"></div>  </li> 
  ...
  <li class="wr12 linhas_inputs editor "> <div class="finput finput_editor min-h300 pl10"> <label class="lnome p0" for="txt_editor"> <p> Descrição completa: </p> </label> <div class="clear"></div> <div class="input dbi"> <textarea id="txt_editor" name="txt_editor" style="visibility: hidden; display: none;">'.$descricao.'</textarea>
<script> editor_criar_extarea(\'txt_editor\'); </script> </div> 

 <div class="clear"></div>  </li>
  <li class="wr12 linhas_inputs editor "> <div class="finput finput_editor min-h300 pl10"> <label class="lnome p0" for="txt_editor"> <p> Titulo da Descrição Extra 01: &nbsp;&nbsp;&nbsp;</p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="txt_extra_01" id="txt_extra_01" value="'.$txt_extra_01.'" class="design "> </div> <div class="clear"></div>  <div class="input dbi"> <textarea id="txt_editor1" name="txt_editor1" style="visibility: hidden; display: none;">'.$descricao1.'</textarea>
<script> editor_criar_extarea(\'txt_editor1\'); </script> </div> 

 <div class="clear"></div>  </li>
    
    
    <li class="wr12 linhas_inputs text ">  <div class="clear"></div><div class="finput finput_txt_extra_02"> <label class="lnome" for="txt_extra_02"> <p> Titulo da Descrição Extra 02: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="txt_extra_02" id="txt_extra_02" value="'.$txt_extra_02.'" class="design "><div class="clear"></div> </div><br><div class="input dbi"> <textarea id="txt_editor2" name="txt_editor2" style="visibility: hidden; display: none;">'.$descricao2.'</textarea>
<script> editor_criar_extarea(\'txt_editor2\'); </script> </div>  <div class="clear"></div>  </li> 
 
 

  
  
  <div class="conteudo_fim"></div> 	<div class="clear"></div>  </fieldset></div></ul>  <div class="h5 clear"></div> </li> </ul>
