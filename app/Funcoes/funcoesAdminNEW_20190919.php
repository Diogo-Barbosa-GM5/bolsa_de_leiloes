...
'.$opleilao.'
 ...
 <div class="clear"></div>  </li>
    <li class="wr4 linhas_inputs text "> <div class="finput finput_cep"> <label class="lnome" for="cep"> <p> CEP: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="cep" id="cep" class="design "> </div></div>

 <div class="clear"></div>  </li>
 
 <li class="wr6 linhas_inputs file "> <div class="finput finput_cep"> <label class="lnome" for="cep"> <p> Bairro: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="bairro" id="bairro" class="design "  value="'.$bairro.'"> </div></div>

 <div class="clear"></div> 

 <div class="clear"></div>  </li> 
 
    <li class="wr6 linhas_inputs text "> <div class="finput finput_endereco"> <label class="lnome" for="endereco"> <p> Endereço: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="endereco" id="endereco" class="design "  value="'.$endereco.'"> </div></div>
 ...
 <div class="clear"></div>  </li>
     ...
     <li class="wr12 linhas_inputs file "> 
...
<option value="2" '.$desocupado[2].'>Não</option>
 ...
 <div class="clear"></div>  </li> 
    ...
    <li class="wr12 linhas_inputs file "> 
      ...
      <label class="lnome" for="google_maps"> <p> Suite: </p> </label>
<div class="input" rel="tooltip" data-original-title=""> <div class="posr">

<select class="design" name="suite">
<option value="1" '.$suite[1].'>Sim</option>
<option value="2" '.$suite[2].'>Não</option>
