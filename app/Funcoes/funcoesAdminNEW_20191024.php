...
<li class="wr3 linhas_inputs text "> <div class="finput finput_incremento"> <label class="lnome" for="suites"> <p> Suites: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="number" name="suites" id="suites" value="'.$suite.'" class="design"> </div></div> <div class="clear"></div>  </li>
 ...
 <div class="clear"></div>  </li> 
  ...
  <li class="wr12 linhas_inputs editor "> <div class="finput finput_editor min-h300 pl10"> <label class="lnome p0" for="txt_editor"> <p> Descrição completa: </p> </label> <div class="clear"></div> <div class="input dbi"> <textarea id="txt_editor" name="descricao" style="visibility: hidden; display: none;">'.$descricao.'</textarea>
 ...
 <div class="clear"></div>  </li>
  <li class="wr12 linhas_inputs text "> <div class="finput finput_txt_extra_01"> <label class="lnome" for="txt_extra_01"> <p> Titulo da Descrição Extra 01: </p> </label> <div class="input" rel="tooltip" data-original-title=""> <input type="text" name="txt_extra_01" id="txt_extra_01" value="'.$txt_extra_01.'" class="design "> </div></div>
