...
class Email extends Mysql {
    ...
    public function enviar(){
        ...
        if($enviado == 0){ // Locaweb
            ...
            if($LOCAL AND mail($to, utf8_decode($assunto), utf8_decode($html), $remetente)){
                $enviado = 2;
            }
        }
        ...
        */
        ...
        if($enviado == 0){
            ...
            if(class_exists('PHPMailer')){
                ...
                $mail->Username = 'AKIASY5IJMXLBD7LDF4Z';;
                $mail->Password = 'BDHA83tJtuKV1DQdjGcjIx7Fwl65uqXVjPpEbwFhmN26';
                $mail->From = $remetente;
