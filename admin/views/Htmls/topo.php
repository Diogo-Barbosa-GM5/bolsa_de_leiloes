<?
	...
	/* HEADER */
		...
		function menu_topo($tipo, $html_menu_left_conteudo){
			$return  = '<ul class="barra" '.iff($tipo==1, 'click="true"', 'hover="true"').'> ';
				...
				$return .= '<li class="menu_topo dnix"> ';
					...
					$return .= '</a> ';
					$return .= '<ul class="boxx_menu"> ';
						$return .= $html_menu_left_conteudo;
					$return .= '</ul> ';
				$return .= '</li> ';
		...
		$html_header .= '<div class="dn_'.MOBILE.' ">'.menu_topo(0, $html_menu_left_conteudo).'</div> ';
		$html_header .= '<div class="dnn_'.MOBILE.'">'.menu_topo(1, $html_menu_left_conteudo).'</div> ';
